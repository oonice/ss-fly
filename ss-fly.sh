...
install_ssr() {
	...
	wget --no-check-certificate https://cdn.jsdelivr.net/gh/teddysun/shadowsocks_install@master/shadowsocksR.sh
...
install() {
        ...
        then
                ...
                echo -e "[${red}错误${plain}] ss服务器安装失败，请联系Suniceman（http://suniceman.com）"
                cleanup
                exit 1
        fi
